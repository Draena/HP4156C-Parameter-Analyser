...
def run_transfer_series(fname, savedir):
    ...
    pa.measure_transfer(device, fname, savedir, -10, 10, 1, 0.1, 0, 1)
    pa.measure_transfer(device, fname, savedir, -20, 20, 1, 0.1, 0, 1)
    pa.measure_transfer(device, fname, savedir, -10, 10, 1, 0.01, 0, 1)
    pa.measure_transfer(device, fname, savedir, -20, 20, 1, 0.01, 0, 1)
